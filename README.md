...
- **Capability-routed data** — yfinance (price), Finnhub (fundamentals/news/insider),
  ...
  KIS (한국투자증권; Korean prices + futures/option chains); pluggable via a
  capability registry + entry points
...
├── data/           # Capability protocols + adapters (yfinance, Finnhub, FRED, DART, KIS) + registry
...
| Data | Multi-source (yfinance, Finnhub, FRED, DART, KIS) |
